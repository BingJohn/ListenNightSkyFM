...
@interface MoodDetailViewController ()

@end

@implementation MoodDetailViewController
...
- (void)downLoadFromNetIsMore:(BOOL)isMore {
    ...
    NSString * urlStr = [NSString stringWithFormat:MoodDetailUrl,page,self.url];
    ...
    [mananger GET:urlStr parameters:nil progress:^(NSProgress * _Nonnull downloadProgress) {
        ...
        MoodDetaiModel * moreModel = [[MoodDetaiModel alloc]initWithData:responseObject error:nil];
