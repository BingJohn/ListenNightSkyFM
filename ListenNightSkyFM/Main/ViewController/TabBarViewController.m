...
- (void)setUpChildVC {
    ...
    [self setChildVC:homeVC title:@"首页" image:@"tabBar_0" selectedImage:@"tabBar_0_selected"];
    
    FindViewController *recommendVC = [[FindViewController alloc] init];
    [self setChildVC:recommendVC title:@"发现" image:@"tabBar_1" selectedImage:@"tabBar_1_selected"];
    
    SocialViewController *ClassificationVC = [[SocialViewController alloc] init];
    [self setChildVC:ClassificationVC title:@"社区" image:@"tabBar_2" selectedImage:@"tabBar_2_selected"];
    
    MeViewController *meVC = [[MeViewController alloc] init];
    [self setChildVC:meVC title:@"我的" image:@"tabBar_3" selectedImage:@"tabBar_3_selected"];
}
...
- (void) setChildVC:(UIViewController *)childVC title:(NSString *) title image:(NSString *) image selectedImage:(NSString *) selectedImage {
    ...
    selectAttr[NSForegroundColorAttributeName] = [UIColor colorWithRed:245/255.0 green:80/255.0 blue:83/255.0 alpha:1.0];
